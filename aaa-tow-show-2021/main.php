...
<html>
  <head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-190916547-4"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-190916547-4');
    </script>
  ...
  <body>
    ...
    <div id="modalContainer">
        <div id="welcomeModal" class="default-modal">
            <div class="welcome-image">
                <img src="images/aaa-logo.jpg"/>
            </div>
            <h2>Welcome to the 2021 Florida Tow Show Event. Please click to enter the exhibit hall to begin your experience!</h2>
            <br>
            <div class="button-red audio-play" onclick="changeRoute(enumRoutes.TRANSITION_FLY_IN)">Enter</div>
        </div>
    </div>
...
<!-- General ----------------------------------------------------------- -->
    <div class="navigation-container">
        <img class="navigation-arrow" onclick="previousRoute()" src="images/left-arrow.png"/>
        <img class="navigation-arrow" onclick="nextRoute()" src="images/right-arrow.png"/>
    </div>
