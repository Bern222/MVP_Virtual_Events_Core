...
<html>
 	 <head>
		...
		<script src="../core-config/config-data/adr/enums/enumRoutes.js?<?php echo rand();?>"></script>  
		<script src="../core-config/config-data/adr/enums/enumModals.js?<?php echo rand();?>"></script>  
		<script src="../core-config/config-data/adr/enums/enumEvents.js?<?php echo rand();?>"></script>  
		...
		<!-- CORE DATA IMPORTS ------------------------------------------------------------------ -->
		<script src="../core-config/config-data/adr/data/dataContent.js?<?php echo rand();?>"></script>  

		<!-- LOCAL DATA IMPORTS ------------------------------------------------------------------ -->
		<script src="js/dataSessions.js?<?php echo rand();?>"></script>  
		
		<!-- CORE-CONFIG IMPORTS ------------------------------------------------------------------ -->
		<script src="../core-config/config-data/adr/config/configMainMenu.js?<?php echo rand();?>"></script>  
		<script src="../core-config/config-data/adr/config/configRoutes.js?<?php echo rand();?>"></script> 
		<script src="../core-config/config-data/adr/config/configModals.js?<?php echo rand();?>"></script> 
		<script src="../core-config/config-data/adr/config/configGlobalVariables.js?<?php echo rand();?>"></script>
		<script src="../core-config/config-data/adr/config/configSiteSettings.js?<?php echo rand();?>"></script>  
