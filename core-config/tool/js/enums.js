var enumsConfigurator = {
    ...
    ROUTE_MODALS: 'routeModals',
    ROUTE_ROUTE_CONFIGURATOR: 'routeRouteConfigurator',
    ROUTE_MODAL_CONFIGURATOR: 'routeModalConfigurator',
    
    SITE_SETTINGS: 'siteSettings',
    ADD_MAIN_MENU_ITEM: 'addMainMenuItem',
    EDIT_MAIN_MENU_ITEM: 'editMainMenuItem',
    MAIN_MENU_ACTION: 'mainMenuAction',
    MAIN_MENU_ACTION_DATA: 'mainMenuActionData',
    ...
    ELEMENT_ACTION_DATA: 'elementActionData'
};